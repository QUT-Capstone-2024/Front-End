...
const GalleryCard: React.FC<GalleryCardProps> = ({
  ...
  // Always set the popover visible when there's no uploaded image
  useEffect(() => {
    if (!uploadedImage) {
  ...
  const popoverContent = (
    <>
      {!uploadedImage ? (
        <p onClick={toggleModal} style={{textAlign: 'center', color: '#808080', marginTop: '30%'}}>These are suggested images for your property generated by VisionLOGIC.</p>
      ) : (
        <>
